...
def main():
    ...
    parser.add_argument("--logging_steps", type=int, default=13870, help="Log every X updates steps.")
    parser.add_argument("--save_steps", type=int, default=13870, help="Save checkpoint every X updates steps.")
    parser.add_argument(
        "--save_total_limit",
        type=int,
        default=None,
